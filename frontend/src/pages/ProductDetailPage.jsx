...
//   const [feedback, setFeedback] = useState(''); // For local "Added to cart!" message
  
//   const { id: productId } = useParams();
//   const navigate = useNavigate();
//   const { addToCart } = useCart();
//   // 2. Get user, token, and showToast
...
//         setLoading(true);
//         setError(null);
//         // This calls your backend route: GET /api/products/:id
...
//     };
//     fetchProduct();
//   }, [productId]); // Re-run if the product ID in the URL changes
...
//       return;
//     }
//     // This will show a toast from CartContext, but we can also have local feedback
...
//         // After deleting, send admin back to the products list
//         navigate('/products');
//       } catch (err) {
...
//   if (loading) return <div className="text-center text-xl mt-10 dark:text-white">Loading product...</div>;
//   if (error) return <div className="text-center text-xl mt-10 text-red-600">{error}</div>;
...
//       <Link to="/products" className="text-blue-600 hover:underline mb-6 inline-block dark:text-blue-400">
...
//         {/* Details Column */}
//         <div className="md:w-1/2">
//           <h1 className="text-4xl font-bold text-gray-800 mb-4 dark:text-white">{product.name}</h1>
//           <p className="text-sm text-gray-500 mb-4 capitalize dark:text-gray-400">Category: {product.category}</p>
//           <p className="text-3xl font-light text-gray-900 mb-6 dark:text-gray-100">{formattedPrice}</p>
//           <p className="text-base text-gray-600 mb-6 leading-relaxed dark:text-gray-300">{product.description}</p>
//           <div className="border-t border-b py-4 dark:border-gray-700">
//             <div className="flex items-center justify-between">
//               <span className="text-gray-700 font-medium dark:text-gray-300">Status:</span>
...
//                     className="px-4 py-2 text-lg font-medium text-gray-700 hover:bg-gray-100 rounded-l-md dark:text-gray-300 dark:hover:bg-gray-700"
//                   >
//                     -
//                   </button>
//                   <input
...
//                     className="px-4 py-2 text-lg font-medium text-gray-700 hover:bg-gray-100 rounded-r-md dark:text-gray-300 dark:hover:bg-gray-700"
//                   >
//                     +
//                   </button>
//                 </div>
...
//                   className="flex-1 bg-blue-600 text-white py-3 rounded-md font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
//                 >
//                   Add to Cart
//                 </button>
//               </div>
...
//           {/* 4. Add the Admin Delete Button */}
//           {user && user.role === 'admin' && (
//             <div className="mt-6 border-t pt-6 dark:border-gray-700">
//               <h3 className="text-lg font-medium text-gray-900 dark:text-white">Admin Actions</h3>
//               <button
//                 onClick={handleDelete}
//                 className="w-full mt-4 bg-red-600 text-white py-3 rounded-md font-medium hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
//               >
//                 Delete This Product
//               </button>
//             </div>
...
const ProductDetailPage = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-10">
