...
//         <p className="text-gray-600 mb-6">Please log in to see your cart items.</p>
//         <Link 
//           to="/login" 
...
//   // Show message if logged in but cart is empty
...
//         {/* Cart Items List (Main Column) */}
//         <div className="lg:w-2/3">
//           <div className="bg-white shadow-md rounded-lg overflow-hidden">
//             <ul className="divide-y divide-gray-200">
//               {cart.items.map((item) => (
//                 <li key={item.productId._id} className="flex flex-col sm:flex-row p-4">
//                   <img 
...
//                         <span className="text-sm font-normal text-gray-600"> x {item.quantity}</span>
//                       </p>
//                       <button 
...
//             <Link 
//               to="/checkout"
//               className="block text-center w-full bg-green-600 text-white py-3 rounded-md font-medium mt-6 hover:bg-green-700 focus:outline-none"
//             >
//               Proceed to Checkout
//             </Link>
//           </div>
